...
# API Crawling
    def crawl_nodes_api(self, page_limit=API_COUNT):
        """
        ...
        :param page_limit: Number of pages of API to crawl. If page_limit=API_COUNT, then crawl all pages.
        """
    ...
    def crawl_registrations_api(self, page_limit=API_COUNT):
        """
    ...
    def crawl_users_api(self, page_limit=API_COUNT):
        """
    ...
    def crawl_institutions_api(self, page_limit=API_COUNT):
        """
...
def save_html(html, page):
    ...
    if 'institution' not in page and 'profile' not in page and 'project' not in page:
        page = 'demo_archive/registration/' + page
    else:
        page = 'demo_archive/' + page
